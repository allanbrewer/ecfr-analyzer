...
def serve_data(path):
    """Serve data files."""
    data_dir = Path(os.environ.get('ECFR_DATA_DIR', Path.cwd().parent.parent.parent / 'data' / 'analysis'))
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Run the eCFR Analyzer website locally.')
